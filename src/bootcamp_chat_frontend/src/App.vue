...
<template>
  <main>
    ...
    <div v-if="principal && !userData">
      <input v-model="newUsername" placeholder="podaj nick"> <button @click="registerUsername"> register</button>
    </div>
    <div v-if="principal && userData" >
      {{ userData.nickname }}
      <div v-if="allUsers">
    ...
    <div class="chatCon">
      <div v-for="chat in chats[0]" class="chat">
        {{ chat }}
      </div>
    </div>
    <div>
